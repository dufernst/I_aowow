...
define( "VIEWER_RACE_HUMAN", "human" );

define( "VIEWER_RACE_ORC", "orc" );

define( "VIEWER_RACE_DWARF", "dwarf" );

define( "VIEWER_RACE_NIGHTELF", "nightelf" );

define( "VIEWER_RACE_UNDEAD", "undead" );

define( "VIEWER_RACE_TUAREN", "tauren" );

define( "VIEWER_RACE_GNOME", "gnome" );

define( "VIEWER_RACE_TROLL", "troll" );

define( "VIEWER_RACE_BLOODELF", "bloodelf" );

define( "VIEWER_RACE_DRAENEI", "draenei" );

define( "VIEWER_RACE_GOBLIN", "goblin" );

define( "VIEWER_RACE_WORGEN", "worgen" );

define( "VIEWER_RACE_PANDAREN", "pandaren" );
...

{
    ...
    protected $Race = VIEWER_RACE_HUMAN;
    ...
    */
...

    {
        ...
        $Name = "VIEWER_RACE_" . strtoupper( $RaceId );
