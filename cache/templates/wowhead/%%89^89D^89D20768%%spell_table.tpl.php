<?php /* Smarty version 2.6.26, created on 2013-10-13 03:57:45
         compiled from bricks/spell_table.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'bricks/spell_table.tpl', 23, false),)), $this); ?>
<?php echo ''; ?><?php $this->assign('level', false); ?><?php echo ''; ?><?php $this->assign('skill', false); ?><?php echo ''; ?><?php $this->assign('reagents', false); ?><?php echo ''; ?><?php $this->assign('percent', false); ?><?php echo ''; ?><?php $_from = $this->_tpl_vars['data']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['curr']):
?><?php echo ''; ?><?php if ($this->_tpl_vars['curr']['level']): ?><?php echo ''; ?><?php $this->assign('level', true); ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['curr']['skill']): ?><?php echo ''; ?><?php $this->assign('skill', true); ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['curr']['reagents']): ?><?php echo ''; ?><?php $this->assign('reagents', true); ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if (isset ( $this->_tpl_vars['curr']['percent'] )): ?><?php echo ''; ?><?php $this->assign('percent', true); ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php endforeach; endif; unset($_from); ?><?php echo 'new Listview('; ?>{<?php echo 'template:\'spell\',id:\''; ?><?php echo $this->_tpl_vars['id']; ?><?php echo '\','; ?><?php if (isset ( $this->_tpl_vars['name'] )): ?><?php echo 'name:LANG.tab_'; ?><?php echo $this->_tpl_vars['name']; ?><?php echo ','; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['percent']): ?><?php echo 'extraCols:[Listview.extraCols.percent],'; ?><?php endif; ?><?php echo 'visibleCols:['; ?><?php if ($this->_tpl_vars['level']): ?><?php echo '\'level\''; ?><?php endif; ?><?php echo '],hiddenCols:['; ?><?php if (! $this->_tpl_vars['reagents']): ?><?php echo '\'reagents\','; ?><?php endif; ?><?php echo ''; ?><?php if (! $this->_tpl_vars['skill']): ?><?php echo '\'skill\','; ?><?php endif; ?><?php echo '\'school\'],sort:['; ?><?php if (isset ( $this->_tpl_vars['sort'] )): ?><?php echo ''; ?><?php echo $this->_tpl_vars['sort']; ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php if ($this->_tpl_vars['percent']): ?><?php echo '\'-percent\','; ?><?php endif; ?><?php echo '\'name\''; ?><?php endif; ?><?php echo '],'; ?><?php if ($this->_tpl_vars['script']): ?><?php echo 'note:sprintf(LANG.lvnote_scripttype, \''; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['script'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?><?php echo '\'),'; ?><?php endif; ?><?php echo ''; ?><?php if (isset ( $this->_tpl_vars['tabsid'] )): ?><?php echo 'tabs:'; ?><?php echo $this->_tpl_vars['tabsid']; ?><?php echo ', parent:\'listview-generic\','; ?><?php endif; ?><?php echo 'data:['; ?><?php unset($this->_sections['i']);
...
$this->_sections['j']['first']      = ($this->_sections['j']['iteration'] == 1);
$this->_sections['j']['last']       = ($this->_sections['j']['iteration'] == $this->_sections['j']['total']);
?><?php echo ''; ?><?php echo $this->_tpl_vars['data'][$this->_sections['i']['index']]['colors'][$this->_sections['j']['index']]; ?><?php echo ''; ?><?php if ($this->_sections['j']['last']): ?><?php echo ''; ?><?php else: ?><?php echo ','; ?><?php endif; ?><?php echo ''; ?><?php endfor; endif; ?><?php echo '],'; ?><?php endif; ?><?php echo ''; ?><?php if (isset ( $this->_tpl_vars['data'][$this->_sections['i']['index']]['percent'] )): ?><?php echo 'percent:'; ?><?php echo $this->_tpl_vars['data'][$this->_sections['i']['index']]['percent']; ?><?php echo ','; ?><?php endif; ?><?php echo 'id:'; ?><?php echo $this->_tpl_vars['data'][$this->_sections['i']['index']]['entry']; ?><?php echo ''; ?>}<?php echo ''; ?><?php if ($this->_sections['i']['last']): ?><?php echo ''; ?><?php else: ?><?php echo ','; ?><?php endif; ?><?php echo ''; ?><?php endfor; endif; ?><?php echo ']'; ?>}<?php echo ');'; ?>