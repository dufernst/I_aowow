<?php /* Smarty version 2.6.26, created on 2013-10-14 05:08:43
         compiled from quest.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'quest.tpl', 11, false),array('modifier', 'replace', 'quest.tpl', 487, false),)), $this); ?>
...
<tr><td><div class="infobox-spacer"></div><center><div id="infobox-sticky-ss"></div></center></td></tr>
				...
				<div class="text">
					<a href="javascript:;" class="button-red" onclick="this.blur(); g_getIngameLink('ffffff00','quest:<?php echo $this->_tpl_vars['quest']['entry']; ?>
:<?php if ($this->_tpl_vars['quest']['QuestLevel'] > 1): ?><?php echo $this->_tpl_vars['quest']['QuestLevel']; ?>
<?php else: ?>1<?php endif; ?>', '<?php echo ((is_array($_tmp=$this->_tpl_vars['quest']['Title'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
