<?php /* Smarty version 2.6.26, created on 2013-10-13 00:27:01
...
<body>
	...
	<div id="home">
		...
		<form method="get" action="." onsubmit="if(trim(this.elements[0].value) == '') return false">
			<input type="text" name="search" size="38" id="kghjklvhj43v6" /><input type="submit" value="<?php echo $this->_config[0]['vars']['search']; ?>
" />
		</form>
