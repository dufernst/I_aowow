<?php /* Smarty version 2.6.26, created on 2013-10-11 18:01:48
...
<?php echo 'new Listview('; ?>{<?php echo 'template:\'quest\',id:\''; ?><?php echo $this->_tpl_vars['id']; ?><?php echo '\',note:\''; ?><?php if ($this->_tpl_vars['locale'] == 8): ?><?php echo ''; ?><?php echo $this->_config[0]['vars']['Quest_Found_total']; ?><?php echo ' '; ?><?php echo $this->_tpl_vars['num_quest']; ?><?php echo ' '; ?><?php echo $this->_config[0]['vars']['Quest_Found']; ?><?php echo ' 300'; ?><?php echo $this->_config[0]['vars']['Quest_Found_2']; ?><?php echo ''; ?><?php elseif ($this->_tpl_vars['locale'] == 0): ?><?php echo ' '; ?><?php echo $this->_tpl_vars['num_quest']; ?><?php echo ' '; ?><?php echo $this->_config[0]['vars']['Quest_Found_total']; ?><?php echo '300 '; ?><?php echo $this->_config[0]['vars']['Quest_Found']; ?><?php echo ''; ?><?php endif; ?><?php echo '\','; ?><?php if (isset ( $this->_tpl_vars['name'] )): ?><?php echo 'name:LANG.tab_'; ?><?php echo $this->_tpl_vars['name']; ?><?php echo ','; ?><?php endif; ?><?php echo ''; ?><?php if (isset ( $this->_tpl_vars['tabsid'] )): ?><?php echo 'tabs:'; ?><?php echo $this->_tpl_vars['tabsid']; ?><?php echo ',parent:\'listview-generic\','; ?><?php endif; ?><?php echo 'data:['; ?><?php unset($this->_sections['i']);
