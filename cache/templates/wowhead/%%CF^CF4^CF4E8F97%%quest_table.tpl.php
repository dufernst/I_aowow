<?php /* Smarty version 2.6.26, created on 2013-10-13 07:52:34
         compiled from bricks/quest_table.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'bricks/quest_table.tpl', 11, false),)), $this); ?>
<?php echo 'new Listview('; ?>{<?php echo 'template:\'quest\',id:\''; ?><?php echo $this->_tpl_vars['id']; ?><?php echo '\','; ?><?php if (isset ( $this->_tpl_vars['name'] )): ?><?php echo 'name:LANG.tab_'; ?><?php echo $this->_tpl_vars['name']; ?><?php echo ','; ?><?php endif; ?><?php echo ''; ?><?php if (isset ( $this->_tpl_vars['tabsid'] )): ?><?php echo 'tabs:'; ?><?php echo $this->_tpl_vars['tabsid']; ?><?php echo ',parent:\'listview-generic\','; ?><?php endif; ?><?php echo 'data:['; ?><?php unset($this->_sections['i']);
