<?php /* Smarty version 2.6.26, created on 2013-10-13 07:51:46
         compiled from bricks/object_table.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'bricks/object_table.tpl', 25, false),)), $this); ?>
...
?><?php echo ''; ?><?php if (isset ( $this->_tpl_vars['curr']['percent'] )): ?><?php echo ''; ?><?php $this->assign('percent', true); ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if (isset ( $this->_tpl_vars['curr']['skill'] )): ?><?php echo ''; ?><?php $this->assign('skill', true); ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php endforeach; endif; unset($_from); ?><?php echo 'new Listview('; ?>{<?php echo 'template:\'object\',id:\''; ?><?php echo $this->_tpl_vars['id']; ?><?php echo '\','; ?><?php if (isset ( $this->_tpl_vars['name'] )): ?><?php echo 'name:LANG.tab_'; ?><?php echo $this->_tpl_vars['name']; ?><?php echo ','; ?><?php endif; ?><?php echo ''; ?><?php if (isset ( $this->_tpl_vars['tabsid'] )): ?><?php echo 'tabs:'; ?><?php echo $this->_tpl_vars['tabsid']; ?><?php echo ',parent:\'listview-generic\','; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['percent']): ?><?php echo 'extraCols:[Listview.extraCols.percent],'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['skill']): ?><?php echo 'visibleCols:[\'skill\'],'; ?><?php endif; ?><?php echo 'sort:['; ?><?php if ($this->_tpl_vars['skill']): ?><?php echo '\'skill\','; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['percent']): ?><?php echo '\'-percent\','; ?><?php endif; ?><?php echo ' \'name\'],hiddenCols:[],data:['; ?><?php unset($this->_sections['i']);
