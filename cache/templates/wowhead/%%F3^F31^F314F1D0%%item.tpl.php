<?php /* Smarty version 2.6.26, created on 2013-10-14 04:37:42
         compiled from item.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'item.tpl', 11, false),array('modifier', 'replace', 'item.tpl', 72, false),)), $this); ?>
...
-generic'), 1, 1);
					...
					<?php if (isset ( $this->_tpl_vars['item']['pagetext'] )): ?>
						<h3>Content</h3>
						<div id="book-generic"></div>
						<?php echo '<script>new Book('; ?>{<?php echo ' parent: \'book-generic\', pages: ['; ?><?php $_from = $this->_tpl_vars['item']['pagetext']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['j'] = array('total' => count($_from), 'iteration' => 0);
...
unset($_smarty_tpl_vars);
 ?><?php endif; ?>
<?php if (isset ( $this->_tpl_vars['item']['containedinspell'] )): ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'bricks/spell_table.tpl', 'smarty_include_vars' => array('id' => 'contained-in-spell','tabsid' => 'tabsRelated','data' => $this->_tpl_vars['item']['containedinspell'],'name' => 'containedin')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?><?php endif; ?>
