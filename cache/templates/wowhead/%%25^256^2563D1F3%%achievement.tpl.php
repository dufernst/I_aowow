<?php /* Smarty version 2.6.26, created on 2013-10-12 01:40:36
...
: <?php if ($this->_tpl_vars['achievement']['points'] == 0): ?> <?php echo $this->_config[0]['vars']['Feat_of_strength']; ?>
 </div></li><?php else: ?> <span class="moneyachievement tip" onmouseover="Listview.funcBox.moneyAchievementOver(event)" onmousemove="Tooltip.cursorUpdate(event)" onmouseout="Tooltip.hide()"> <?php echo $this->_tpl_vars['achievement']['points']; ?>
