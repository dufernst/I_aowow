<?php /* Smarty version 2.6.26, created on 2013-10-14 04:58:58
         compiled from npc.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'npc.tpl', 11, false),array('modifier', 'string_format', 'npc.tpl', 44, false),)), $this); ?>
...
<?php endif; ?> 
<?php if (( $this->_tpl_vars['npc']['kill_rep_value1'] || $this->_tpl_vars['npc']['kill_rep_value2'] )): ?>
						<li><div><?php echo $this->_config[0]['vars']['Onkill']; ?>
: <?php echo ''; ?><?php if ($this->_tpl_vars['npc']['kill_rep_value1']): ?><?php echo ''; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['npc']['kill_rep_value1'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%+d") : smarty_modifier_string_format($_tmp, "%+d")); ?><?php echo ' '; ?><?php echo $this->_config[0]['vars']['reputationwith']; ?><?php echo ' '; ?><?php echo $this->_tpl_vars['npc']['kill_rep_faction1']; ?><?php echo ' '; ?><?php echo $this->_config[0]['vars']['until']; ?><?php echo ' '; ?><?php echo $this->_tpl_vars['npc']['kill_rep_until1']; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if (( $this->_tpl_vars['npc']['kill_rep_value1'] && $this->_tpl_vars['npc']['kill_rep_value2'] )): ?><?php echo '<br><span style="visibility: hidden;">'; ?><?php echo $this->_config[0]['vars']['Onkill']; ?><?php echo ': </span>'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['npc']['kill_rep_value2']): ?><?php echo ''; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['npc']['kill_rep_value2'])) ? $this->_run_mod_handler('string_format', true, $_tmp, "%+d") : smarty_modifier_string_format($_tmp, "%+d")); ?><?php echo ' '; ?><?php echo $this->_config[0]['vars']['reputationwith']; ?><?php echo ' '; ?><?php echo $this->_tpl_vars['npc']['kill_rep_faction2']; ?><?php echo ' '; ?><?php echo $this->_config[0]['vars']['until']; ?><?php echo ' '; ?><?php echo $this->_tpl_vars['npc']['kill_rep_until2']; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?>
</div></li>
<?php endif; ?> 
