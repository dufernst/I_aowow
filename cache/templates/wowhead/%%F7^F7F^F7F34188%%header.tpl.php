...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'header.tpl', 13, false),)), $this); ?>
	...
	<div id="header">
		...
		<div id="toptabs">
			<div id="toptabs-inner">
				...
				<div align="right"><?php if ($this->_tpl_vars['user']): ?><a href="?user=<?php echo $this->_tpl_vars['user']['name']; ?>
"><?php echo $this->_tpl_vars['user']['name']; ?>
</a> (<a href="/?reputation" style="color: rgb(0,255,0)"><?php echo $this->_tpl_vars['reputation']['totalrep']; ?>
